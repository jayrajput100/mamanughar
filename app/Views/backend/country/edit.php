    ...
    <div class="row">
      <div class="col-lg-12 layout-spacing col-md-12">
        <form class="needs-validation general-info" novalidate id="form">
            <input type="hidden" id="action" name="action" value="country/update">
                    ...
                    <div class="card-body">
                        <div class="form-row">
                          <div class="col-md-12 mb-2">
                            ...
                            <input type="text" class="form-control" id="validationCustom01" value="<?php print_r($country['country_name']) ?>" placeholder="Country Name..."  required name="country_name" id="country_name">
                        ...
                        <div class="form-row">
                          <div class="col-md-12 mb-2">
                            ...
                            <textarea class="form-control" placeholder="Country note" name="note"><?php print_r($country['country_name']) ?></textarea>
                          </div>
                        </div>
                    </div>  
