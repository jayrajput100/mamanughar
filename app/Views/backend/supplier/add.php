              ...
              <div class="card-body">
                    ...
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-6">
                         ...
                         <input type="text" minlength="6" class="form-control" id="validationCustom01" name="pin_code" placeholder="Enter Pin Code" required>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" class="form-control mb-4"  name="phone_no" placeholder="(999) 999-9999">
                          <div class="valid-feedback"> Looks good! </div>
                        </div>
                    </div>  <!--  END Fifth row  -->
                    <div class="form-row">
                    ...
                    <div class="form-row">
                      <div class="form-group col-md-4">
                        ...
                        <select class="form-control" name="category_id[]" id="category_id_0" required onchange="drpchange(this,0)" data-actions-box="true">
                       ...
                       <div class="form-group col-md-4">
                        ...
                        <select class="selectpicker form-control sub" name="subcategory_id[]" id="subcategory_id_0" multiple  required onchange="subdrpchange(this,0)" data-actions-box="true">
