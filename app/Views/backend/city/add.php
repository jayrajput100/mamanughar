    ...
    <div class="row">
      <div class="col-lg-12 layout-spacing col-md-12">
        <form class="needs-validation general-info" novalidate id="form">
            <input type="hidden" id="action" name="action" value="city/add">
            <div class="info">
                <div class="card card-theme">
                    <div class="card-heading">
                        <div class="portlet-title portlet-warning d-flex justify-content-between">
                            <div class="caption  align-self-center">
                               <h4 class="card-title"> <span class="caption-subject text-uppercase white ml-1"> <i class="fa fa-plus"></i> Add City</span></h4>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="form-row">
                          <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="validationCustom01" placeholder="Add city Name..."  required name="city_name" id="city_name">
                        ...
                        <div class="form-row">
                          <div class="col-md-12">
                            <label for="validationCustom01">City note </label>
                            <textarea class="form-control" placeholder="City note" name="note"></textarea>  
                          </div>
                        </div>
                    </div>
