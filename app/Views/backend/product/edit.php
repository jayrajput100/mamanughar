    ...
    <div class="row">
      <div class="col-lg-12 layout-spacing col-md-12">
        <form class="needs-validation general-info" novalidate id="form">
            <input type="hidden" id="action" name="action" value="product/update">
                    ...
                    <div class="card-heading">
                        <div class="portlet-title portlet-warning d-flex justify-content-between">
                            <div class="caption  align-self-center">
                               <h4 class="card-title"> <span class="caption-subject text-uppercase white ml-1"> <i class="fa fa-plus"></i> Update Product</span></h4>
                            </div>
                    ...
                    <div class="card-body">
                             ...
                             <?php 
                               ...
                               foreach ($category as $key => $value) 
                                { 
                                  ...
                                  ?>
                                <option value="<?php echo $value['category_id'] ?>" <?php echo ($value['category_id']==$product['category_id'])?"selected=true":'' ?>><?php echo $value['category_name'] ?></option>
                              <?php
                                 } 
                              ?>
                            </select>
                        ...
                        <div class="form-row">
                          ...
                          <select class="form-control " name="subcategory_id" id="subcategory_id" required onchange="subdrpchange(this.value)">
                            ...
                            <?php 
                              ...
                              $subcategory= $this->simple->fetch_subcategory($product['category_id']);
                               foreach ($subcategory as $key => $value) 
                                { 
                                 
                                  ?>
                                <option value="<?php echo $value['subcategory_id'] ?>" <?php echo ($value['subcategory_id']==$product['sub_category_id'])?"selected=true":'' ?>><?php echo $value['sub_cat_name'] ?></option>
                              <?php
                                 } 
                              ?>
                          </select> 
                         ...
                         <label for="validationCustompersonname">Product Third Subcategory</label>
                          <select class="form-control " name="third_subcategory_id" id="third_subcategory_id">
                             <option value="">Please Select Sub Category</option>
                               ...
                               $third_subcategory_id= $this->simple->fetch_third_subcategory($product['sub_category_id']);
                               foreach ($third_subcategory as $key => $value) 
                                { 
                                 
                                  ?>
                                <option value="<?php echo $value['third_subcategory_id'] ?>" <?php echo ($value['third_subcategory_id']==$product['third_category_id'])?"selected=true":'' ?>><?php echo $value['third_subcategory_name'] ?></option>
                              <?php
                                 } 
                              ?>
                          </select>
                        ...
                        <div class="form-row">
                          <div class="col-md-12 mb-2">
                            ...
                            <textarea class="form-control" placeholder="Product Description" name="product_desc"><?php echo  $product['product_desc'] ?></textarea>  
                            <div class="valid-feedback"> Looks good! </div>
                          </div>
                        </div>
