    ...
    <div class="row">
      <div class="col-lg-12 layout-spacing col-md-12">
        <form class="needs-validation general-info" novalidate id="form">
          <input type="hidden" id="action" name="action" value="user/add">
          <div class="info">
              ...
              <div class="card-body">
                <div class="form-row">
                  ...
                  <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="validationCustom02" name="company_name" placeholder="Company Name" >
                    <div class="invalid-feedback">
                      Please provide a valid Last name.
                    </div>
                  </div>
                ...
                <div class="form-row">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="validationCustomMobile" name="mobile" placeholder="Mobile" required>
                    <div class="invalid-feedback">
                ...
                <div class="form-row">
                  <div class="col-md-12">
                    ...
                    <div class="input-group">
                      <textarea type="text" class="form-control" name="address"  id="validationCustomEmail" placeholder="Address" aria-describedby="inputGroupPrepend" required> </textarea>
                      <div class="invalid-feedback">
                        Please provide a valid email.
                      </div>
                    </div>
