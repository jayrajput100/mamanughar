    ...
    <div class="row">
      <div class="col-lg-12 layout-spacing col-md-12">
        <form class="needs-validation general-info" novalidate id="form">
            <input type="hidden" id="action" name="action" value="state/add">
            <div class="info">
                <div class="card card-theme">
                    <div class="card-heading">
                        <div class="portlet-title portlet-warning d-flex justify-content-between">
                            <div class="caption  align-self-center">
                               <h4 class="card-title"> <span class="caption-subject text-uppercase white ml-1"> <i class="fa fa-plus"></i> Add State</span></h4>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="form-row">
                          <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="validationCustom01" placeholder="Country Name..."  required name="state_name" id="state_name">
                        ...
                        <div class="form-row">
                          <div class="col-md-12">
                            ...
                            <textarea class="form-control" placeholder="State note" name="note"></textarea>  
                          </div>
                        </div>
                    </div>
