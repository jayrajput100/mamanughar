...
<head>
    ...
    <link href="<?php echo base_url(); ?>/theme/assets/css/users/login-1.css" rel="stylesheet" type="text/css" />
...
<body class="login">
    ...
    <form class="form-login" id="form">
        <input type="hidden" id="action" name="action" value="admin/login_code">
        <input type="hidden" id="actionmsg" name="actionmsg" value="Loging.. please wait..">
