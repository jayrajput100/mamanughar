...
<main class="bg_gray pattern margin_60_40">
  <div class="container margin_60_40">
    <div class="row justify-content-center">
	  <div class="col-lg-6"> 
	    <form id="form">
	      <input type="hidden" id="action" value="verifyotp">
          ...
          <div class="sign_up">
            ...
            <h3 class="main_question wizard-header">Enter the code we just send on your mobile phone<strong> +91 <?php echo  $data['user_mobile'] ?></strong>
            ...
            <div class="collapse hide" id="collapseFilters" style="">
                      ...
                      Enter the Number You want the OTP
                        <div class="form-group">
                            <input class="form-control required error" placeholder="Enter Mobile Number" name="user_mobile" id="user_mobile" maxlength="10" minlength="10" required="true" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" value="<?php echo  $data['user_mobile'] ?>" id="user_mobile">
                          ...
                          <button type="button" name="process" class="btn_1 btn_scroll" onclick="send_otp()">
                           Send OTP 
              ...
              <h3 class="main_question wizard-header">Don't receive the code?  <a href="#" onclick="resend_otp()">Resend OTP</a></h3>
